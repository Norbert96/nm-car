...
u1 = np.array([790.5, 837.06819962, 883.63639924, 903.28577023])
u2 = np.array([504.88562373, 434.82135311, 369.6925607, 369.6925607])

b2 = Bezier(u1, u2)

split = b2.split(0.9999999999999999, 1.0999999999999999)
b = Bezier(x, y)
b1 = Bezier(x1, y1)
